module Example.Monadic.LifeCycle where
...
import OutWatch.Monadic.Attributes (childShow_, children_, inputNumber_, max_, src_, style_, type_, valueShow_)
import OutWatch.Monadic.Tags (div_, img_, input_, li_, ol_)
import OutWatch.Monadic.Types (HTML)
import OutWatch.Monadic.Utils (build, createHandler_, toVDom)
